...
void Ball::Init(GLuint modelID, GLuint normalmatrixID) {
	numlats = 40;
	numlongs = 40;
...
GLuint Ball::makeSphereVBO(GLuint numlats, GLuint numlongs)
{
	GLuint i, j;
...
been created.
*/
void Ball::makeUnitSphere(GLfloat *pVertices, GLuint numlats, GLuint numlongs)
{
